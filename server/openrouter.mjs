...
// и смешение языков в ответах. openai/gpt-oss-20b:free добавлена вторым номером — по логам она
// стабильно отвечала по делу, когда до неё доходило, — чтобы реже скатываться в полную лотерею
// openrouter/free (он всё ещё последний в списке — обязательная подстраховка по разделу 3 ТЗ).
